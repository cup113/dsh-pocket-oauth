...
export function installPocketRpc(ctx, { service, log = console, desktop = false, runUpdate = null, restart = null, restartNotice = null, getOAuthView = null, rotateSession = null, unbindOAuth = null, setMobileRightbarEnabled = null, resetPocket = null }) {
  const pocketRpcHandler = async (endpoint, payload = {}, signal) => {
    ...
    const statusPayload = async () => {
      ...
      return ok({
        ...
        mobileRightbarEnabled: s.mobileRightbarEnabled ?? true,
        oauth: getOAuthView?.() ?? { configured: false, callbackOrigins: [], bound: false, boundLogin: null },
      });
    };
